...
public class OverScrollViewBehavior extends AppBarLayout.Behavior {
    ...
    public OverScrollViewBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
...
//        middleLayout.setBottom(mLastBottom);
    ...
    public void setOnProgressChangeListener(OverScrollViewBehavior.onProgressChangeListener onProgressChangeListener) {

package com.lxy.shop.ui.game.adapter;
...
public class GameAdapter extends BaseQuickAdapter<AppBean, BaseViewHolder> {

    private String baseImgUrl = "http://file.market.xiaomi.com/mfc/thumbnail/png/w150q80/";
    private List<AppBean> mList = new ArrayList<>();

    public GameAdapter(@LayoutRes int layoutResId, @Nullable List<AppBean> data) {
